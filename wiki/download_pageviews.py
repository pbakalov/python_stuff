...
def get_views(project, access, agent, article, granularity, start, end):
    #print ('https://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/{0}/{1}/{2}/{3}/{4}/{5}/{6}'.format(project, access, agent, article, granularity, start, end))
    try:
